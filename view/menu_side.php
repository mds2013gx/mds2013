					...
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li>
							...
							<ul>
								...
								<li><a class="submenu" href="tasks.php"><i class="icon-calendar"></i><span class="hidden-tablet"> Por Trimestre</span></a></li>
								<li><a class="submenu" href="tasks.php"><i class="icon-calendar"></i><span class="hidden-tablet"> Por Quadrimestre</span></a></li>
								<li><a class="submenu" href="tasks.php"><i class="icon-calendar"></i><span class="hidden-tablet"> Por Ano</span></a></li>
							</ul>
						</li>
						<li>
